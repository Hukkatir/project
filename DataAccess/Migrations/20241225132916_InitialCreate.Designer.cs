...
namespace DataAccess.Migrations
{
    ...
    [Migration("20241225132916_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Models.CategoryContent", b =>
                {
            ...
            modelBuilder.Entity("Domain.Models.MediaFile", b =>
                {
                    b.Property<int>("MediaId")
                        .HasColumnType("int")
                        .HasColumnName("MediaID");
            ...
            modelBuilder.Entity("Domain.Models.MediaType", b =>
                {
            ...
            modelBuilder.Entity("Domain.Models.MyRating", b =>
                {
            ...
            modelBuilder.Entity("Domain.Models.RoomsUser", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int")
                        .HasColumnName("UserID");
            ...
            modelBuilder.Entity("Domain.Models.StatusMessage", b =>
                {
                    b.Property<int>("StatusMessageId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CommentMedium", b =>
                {
                    ...
                    b.HasOne("Domain.Models.Medium", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Models.Content", b =>
                {
                    b.HasOne("Domain.Models.CategoryContent", "CategoryContent")
                        .WithMany("Contents")
                    ...
                    b.HasOne("Domain.Models.Medium", "Media")
                        .WithMany("Contents")
                        .HasForeignKey("MediaId")
                        .IsRequired()
            ...
            modelBuilder.Entity("Domain.Models.File", b =>
                {
                    b.HasOne("Domain.Models.CategoryFile", "CategoryFile")
                        .WithMany("Files")
            ...
            modelBuilder.Entity("Domain.Models.Medium", b =>
                {
                    ...
                    b.HasOne("Domain.Models.MediaType", "MediaType")
                        .WithMany("Media")
            ...
            modelBuilder.Entity("Domain.Models.MessagesUser", b =>
                {
                    ...
                    b.HasOne("Domain.Models.StatusMessage", "StatusMessage")
                        .WithMany("MessagesUsers")
            ...
            modelBuilder.Entity("RelatedMedium", b =>
                {
                    b.HasOne("Domain.Models.GroupMedium", null)
                        .WithMany()
